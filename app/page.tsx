...
export default async function Home() {
  ...
  return <><Header/><main>
    ...
    <section id="college-football" className="dark-band"><div className="shell content-section"><div className="section-row"><div><small>THE DAILY HUDDLE</small><h2>College Football News</h2></div><p>Breaking news, recruiting, the portal, coaching and everything shaping Saturdays.</p></div><div className="news-grid">{college.map(a => <ArticleCard key={a.id} article={a}/>)}</div></div></section>
