...
export function Header() {
  ...
  return <>
    ...
    <header className="header shell">
      ...
      <nav><Link href="/#top-stories">Top Stories</Link><Link href="/schools">Schools</Link><Link href="/#college-football">College Football</Link><Link href="/#other-news">Other News</Link><a href="https://play.underdogsports.com/vgwg/p-ttm">Underdog</a></nav>
